...
"""Read the input CSV/TSV/XLS/XLSX file(s) and the parameters JSON file,
create the output folder and launch LipidFinder's PeakFilter.
"""
...
from LipidFinder import PeakFilter
...
def main ():
    ...
    parser.add_argument('-i', '--input', metavar='INPUT', type=str,
                        required=True, help="file or folder with input data")
